...
class WebDataLoder {
    ...
    async loadImg (categoryNum, start, end){
        let url = `https://sik.search.blue.cdtapps.com/kr/ko/product-list-page/more-products?category=${this.categoryData.getIkeaCode(categoryNum)}&start=${start}&end=${end}&c=lf&v=20220826&sort=RELEVANCE`
